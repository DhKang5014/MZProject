				...
				<section id="banner">
					<div class="content">
						<header>
							...
							<p id="stitle">A free and fully responsive site template</p>
						</header>
						<p id="content">Aenean ornare velit lacus, ac varius enim ullamcorper eu.
							...
							sit nullam.</p>
						<ul class="actions">
							<li><a href="external_diary_title.html" class="button big">Learn More</a></li>
						</ul>
					</div>
				...
				<section>
					...
					<div class="posts">
						<article>
							...
							<ul class="actions">
								<li><a href="imgDiary.jsp" class="button" id="img1_button">More</a></li>
							</ul>
						</article>
						<article>
							...
							<p id="img2_plu_name">Aenean ornare velit lacus, ac varius enim lorem
								...
								nulla amet lorem feugiat tempus aliquam.</p>
							<ul class="actions">
								<li><a href="#" class="button" id="img2_button">More</a></li>
							</ul>
						</article>
						<article>
							...
							<p id="img3_plu_name">Aenean ornare velit lacus, ac varius enim lorem
								...
								nulla amet lorem feugiat tempus aliquam.</p>
							<ul class="actions">
								<li><a href="imgDiary.jsp" class="button" id="img3_button">More</a></li>
							</ul>
						</article>
						<article>
							...
							<p id="img4_plu_name">Aenean ornare velit lacus, ac varius enim lorem
								...
								nulla amet lorem feugiat tempus aliquam.</p>
							<ul class="actions">
								<li><a href="imgDiary.jsp" class="button" id="img4_button">More</a></li>
							</ul>
						</article>
						<article>
							...
							<p id="img5_plu_name">Aenean ornare velit lacus, ac varius enim lorem
								...
								nulla amet lorem feugiat tempus aliquam.</p>
							<ul class="actions">
								<li><a href="imgDiary.jsp" class="button" id="img5_button">More</a></li>
							</ul>
						</article>
						<article>
							...
							<p id="img6_plu_name">Aenean ornare velit lacus, ac varius enim lorem
								...
								nulla amet lorem feugiat tempus aliquam.</p>
							<ul class="actions">
								<li><a href="imgDiary.jsp" class="button" id="img6_button">More</a></li>
							</ul>
						</article>
					</div>
				</section>
		            ...
		            data : { name : "gil-dong", location : "seoul" },
		                 ...
		                 //1
 						 if(img_dict['0']===undefined){
			                 ...
			                 $('#img1_plu_name').text(img_dict['0_plu_name']);
		                 }
 						...
 						if(img_dict['1']===undefined){
			                 ...
			                 $('#img2_plu_name').text(img_dict['1_plu_name']);
		                 }
 						//3
 						if(img_dict['2']===undefined){
			                 ...
			                 $('#img3_plu_name').text(img_dict['2_plu_name']);
		                 }
 						//4
 						if(img_dict['3']===undefined){
			                 ...
			                 $('#img4_plu_name').text(img_dict['3_plu_name']);
		                 }
 						//5
 						if(img_dict['4']===undefined){
			                 ...
			                 $('#img5_plu_name').text(img_dict['4_plu_name']);
		                 }
 						...
 						if(img_dict['5']===undefined){
			                 ...
			                 $('#img6_plu_name').text(img_dict['5_plu_name']);
		                 }
